...
public class DescriptionHolyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            tvDescriptionActivity.setText(Html.fromHtml(textDescriptionHoly(description_id).replace("\r\n", "<br>")));
    ...
    public String textDescriptionHoly(String id) {
        String text = "";

        cursor = db.executeQuery("select holiday_description from description_holiday where _id=" + id + ";");
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                do {
                    try {
                        text = cursor.getString(cursor.getColumnIndex("holiday_description"));
