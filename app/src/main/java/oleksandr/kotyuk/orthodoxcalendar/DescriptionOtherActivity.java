...
public class DescriptionOtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DescriptionHolyActivityHostFree
        //DescriptionLessonsActivityHostFree

        if (intent.getStringExtra("description_id_search_holy")!=null && intent.getStringExtra("description_id_search_holy").equals("DescriptionHolyActivityHostFree")){
            host="DescriptionHolyActivityHostFree";
            description_id=intent.getStringExtra("id");
            //alert("TEST DescriptionHolyActivityHostFree ID="+description_id, "Внимание");
        }

            try {
                if (host.equals(GlobalData.getDESCRIPTION_HOLY_ACTIVITY_HOST()) || host.equals(GlobalData.getDESCRIPTION_LESSONS_ACTIVITY_HOST()))
        ...
        if (host.equals(GlobalData.getDESCRIPTION_HOLY_ACTIVITY_HOST()))
            tvDescriptionActivityLink.setTypeface(tvDescriptionActivity.getTypeface());
        black_fon_color = PreferencesActivity.MyPreferenceFragment.ReadString(
                this, "pref_black_fon_color", "black");
        if (description_style) {
            if (black_fon_color.equals("black"))
                llDescriptionActivity.setBackgroundColor(getResources().getColor(R.color.BLACK));
            if (black_fon_color.equals("dark_green"))
                llDescriptionActivity.setBackgroundColor(getResources().getColor(R.color.dark_green));
            if (black_fon_color.equals("blue"))
                llDescriptionActivity.setBackgroundColor(getResources().getColor(R.color.blue));
            if (black_fon_color.equals("dark_blue"))
                llDescriptionActivity.setBackgroundColor(getResources().getColor(R.color.dark_blue));
