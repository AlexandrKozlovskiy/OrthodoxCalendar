...
MyScheduledReceiver.setAlarm(this);
        ...
        dataList.add(new DrawerItem(getString(R.string.search_holy),
                R.drawable.ic_action_crucifixion));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, R.string.drawer_open,
            ...
            public void onDrawerClosed(View view) {
                ...
                if (getDrawerToggleDelegate() != null)
                    getDrawerToggleDelegate().setActionBarDescription(R.string.drawer_open);
            }
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                getSupportActionBar().setTitle(mDrawerTitle);
                if (getDrawerToggleDelegate() != null)
                    getDrawerToggleDelegate().setActionBarDescription(R.string.drawer_close);
...
// onPrepareOptionsMenu()
 ...
 if (dataList.get(0).getTitle() != null) {
  ...
  SelectItem(0);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU && checkSelfPermission(Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED && !sp.getBoolean(requestedPermissionsKey, false) /*&&shouldShowRequestPermissionRationale(Manifest.permission.POST_NOTIFICATIONS)*/)
  ...
  break;*/
            ...
            case R.id.button_Bible4:
                ...
                if (intent_id_number != -1 && id_bible_book != -1 && line_text_bible_book != -1) {
                    ...
                    alert("Сохраненной страницы еще нет, поскольку Вы еще не читали!!!", "Внимание");
                break;
  ...
  menu_activ_prayers_fonts=true;*/
    ...
    public void SelectItem(int position) {
        if (list_position_st != position) {
            ...
            if (position == 10 || position == 12 || position == 4) {
                ...
                switch (position) {
                    ...
                    /*case 4:
                        ...
                        cal.setTodayDate();
                        fragment = new FragmentSearchHoly();
                        args.putString(FragmentSearchHoly.ITEM_NAME,
                                dataList.get(position).getItemName());
                        args.putInt(FragmentSearchHoly.IMAGE_RESOURCE_ID, dataList
