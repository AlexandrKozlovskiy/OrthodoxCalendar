...
public View getView(int position, View convertView, ViewGroup parent) {
 ...
 if(standart_text_size3==0) standart_text_size3=viewHolder.text_values_big.getTextSize();//19
 if(standart_text_size4==0) standart_text_size4=viewHolder.text_values_post.getTextSize();//16
