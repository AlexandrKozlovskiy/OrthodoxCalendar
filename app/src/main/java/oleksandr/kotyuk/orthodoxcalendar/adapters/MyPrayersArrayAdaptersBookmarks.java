...
public class MyPrayersArrayAdaptersBookmarks extends ArrayAdapter<String> {

    static final String TAG = "myLogs";

    private final Activity context;
    //private final String[] prayers_name;
    private ArrayList<String> prayers_name_list;
...
/*public MyPrayersArrayAdaptersBookmarks(Activity context, int resource,
 int MyViewResourceId, String[] prayers) {
 super(context, resource, MyViewResourceId, prayers);
 // TODO Auto-generated constructor stub
 this.context = context;
 this.prayers_name_list = new ArrayList<String>(Arrays.asList(prayers));
}*/

    public MyPrayersArrayAdaptersBookmarks(Activity context, int resource,
                                           int MyViewResourceId, ArrayList<String> prayers) {
        super(context, resource, MyViewResourceId, prayers);
        // TODO Auto-generated constructor stub
        this.context = context;
        this.prayers_name_list = prayers;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.my_list_item_click_drag_remove,
                    null, true);
        ...
        prayers_language = PreferencesActivity.MyPreferenceFragment.ReadString(
                getContext(), "pref_prayers_language", "ru");

        if (prayers_language.equals("ru")) {
            String prayers_fonts_ru = PreferencesActivity.MyPreferenceFragment
                    .ReadString(context, "pref_prayers_fonts_ru", "1");
            ...
            viewHolder.tv_prayers_name.setText(prayers_name_list.get(position));
        } else {
            String prayers_fonts_cs = PreferencesActivity.MyPreferenceFragment
                    .ReadString(context, "pref_prayers_fonts_cs", "1");
        ...
        if (size == 0)
            size = viewHolder.tv_prayers_name.getTextSize();
