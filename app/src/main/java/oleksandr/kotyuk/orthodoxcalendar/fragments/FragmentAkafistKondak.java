...
public class FragmentAkafistKondak extends Fragment {
...
public View onCreateView(LayoutInflater inflater, ViewGroup container,
 ...
 v = inflater.inflate(R.layout.fragment_view_pager_prayers_ak, null);
 return v;
}
...
public void onActivityCreated(Bundle savedInstanceState) {
 ...
 cursor = db.executeQuery("SELECT _id, name_group FROM prayers_ru_ak_group;");
 ...
 db = DatabaseHelper.getInstance(getActivity()
  .getApplicationContext());
 cursor = db.executeQuery("SELECT _id, name_group FROM prayers_cs_ak_group;");
 ...
 MySimpleCursorTreeAdapterPsaltur sctAdapter = new MyAdapter(getActivity().getApplicationContext(), cursor,
        ...
        childTo);
    elvMain = (ExpandableListView) v.findViewById(R.id.elv_prayers_ak);
...
class MyAdapter extends MySimpleCursorTreeAdapterPsaltur {
  ...
  Context context;
   ...
   getActivity(), "pref_prayers_language", "ru");
       ...
       if (prayers_language.equals("ru")) {
       sql2="select * from prayers_ru_ak where id_group="+idColumn;
       }
       else{
       sql2="select * from prayers_cs_ak where id_group="+idColumn;
       }
