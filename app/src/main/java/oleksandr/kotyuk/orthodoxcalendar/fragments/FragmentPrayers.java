...
public class FragmentPrayers extends Fragment {
    ...
    private void inflateList() {
        ...
        if (prayersType.equals("kafisma"))
            cursor = db.executeQuery("SELECT _id, kafisma_" + prayers_language + " FROM psaltur_group;");
        else
            cursor = db.executeQuery("SELECT _id, name_group FROM prayers_" + prayers_language + "_" + prayersType + "_group;");
    ...
    public void setArguments(@Nullable Bundle args) {
        ...
        if (args != null && args.containsKey("prayers_type"))
            setPrayersType(args.getString("prayers_type"));
    }
