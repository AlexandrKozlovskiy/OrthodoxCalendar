...
import oleksandr.kotyuk.orthodoxcalendarfree.adapters.CustomDrawerAdapter;
import oleksandr.kotyuk.orthodoxcalendarfree.db.DatabaseHelper;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.DatePickerFragment1;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentAbout;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentAkafistKondak;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentBible;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentDirectory;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentDirectory2;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentEaster;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentHelp;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentHolidays;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentPosts;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentPrayers;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentPrayersBookmarks2;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentPrayersTroparKondakDay;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentPsaltur;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentSouls;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.FragmentViewPager;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.LastReadPsalturDialogFragment;
import oleksandr.kotyuk.orthodoxcalendarfree.fragments.UpdateNewsDialogFragment;
			...
			if (position == 10 || position == 12) {
				if (position == 10) {
					...
					intent_m.setData(Uri
							.parse("market://details?id=oleksandr.kotyuk.orthodoxcalendarfree"));
