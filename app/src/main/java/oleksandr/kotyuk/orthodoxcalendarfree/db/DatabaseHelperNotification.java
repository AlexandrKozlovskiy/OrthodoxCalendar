...
public class DatabaseHelperNotification extends SQLiteOpenHelper {
	...
	static boolean update_flag_notif=false;
	...
	private static DatabaseHelperNotification dbHelper = null;

	private static SQLiteDatabase db = null;

	private final Context db_context;

	private DatabaseHelperNotification(Context context) {
	...
	public void onUpgrade(SQLiteDatabase database, int oldVersion,
			int newVersion) {
		//Toast.makeText(db_context, "Notification", Toast.LENGTH_SHORT).show();
		//executeUpdateSQLScriptZIP(database, DB_NAME_ZIP, oldVersion);
		update_flag_notif=true;
	...
	public static synchronized DatabaseHelperNotification getInstance(Context context) {
		Log.d(TAG, "DatabaseHelper getInstance()");
		if (dbHelper == null) {
			dbHelper = new DatabaseHelperNotification(context);
			openConnecion();
		}
		return dbHelper;
	}
