...
public class ConfigActivity extends Activity {
	...
	public final static String WIDGET_VISIBLE_FZ = "widget_visible_fz_";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int widgetColorTransparent = sp.getInt(
				ConfigActivity.WIDGET_COLOR_TRANSPARENT + widgetID, 0);
		...
		adapter4.setDropDownViewResource(R.layout.my3_simple_spinner_dropdown_item);
	...
	public void onClick(View v) {
		...
		Spinner spinner3 = (Spinner) findViewById(R.id.spinnerConfig3);
		int selRBFZ = spinner3.getSelectedItemPosition();
		int fz = 0;
		switch (selRBFZ) {
		case 0:
			// Log.d(LOG_TAG, "radioTransparent_0");
		...
		Spinner spinner4 = (Spinner) findViewById(R.id.spinnerConfig4);
		int selRBTS = spinner4.getSelectedItemPosition();
		int ts = 0;
		switch (selRBTS) {
		case 0:
			ts = -5;
		...
		editor.putInt(WIDGET_VISIBLE_FZ + widgetID, fz);
		...
		MyWidget.updateWidget(this, appWidgetManager, widgetID, sp);
