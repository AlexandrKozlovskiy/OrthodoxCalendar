...
import oleksandr.kotyuk.orthodoxcalendarfree.models.MyCalendarWidget;
	...
	public void onDataSetChanged() {
		...
		if (cal.getDateEntersPeriods()) {
				...
				if (cursor.moveToFirst()) {
					try {
						...
						text_icon_holiday = text_icon_holiday.replace("\r\n",
								"<br>");
						if(!text_icon_holiday.equals(""))text_icon_holiday=text_icon_holiday + "<br>";
			...
			if(widgetVisibleFZ==0 && !text_fz.equals("")){
				if (tmp.equals("")) tmp="<FONT COLOR=RED><big><b>Мысли Феофана Затворника:</b></big></FONT><br>"+text_fz;
				else tmp=tmp+"<br><FONT COLOR=RED><big><b>Мысли Феофана Затворника:</b></big></FONT><br>"+text_fz;
			}
			...
			data.add("Пожалуйста проверьте дату на устройстве, программа работает в интервале 2019г - 2022г.");
			data.add(" ");
		}
		// data.add("test");
